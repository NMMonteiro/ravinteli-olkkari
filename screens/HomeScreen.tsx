    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-white font-display pb-20">
      ...
      <header className="sticky top-0 z-40 bg-background-dark/95 backdrop-blur-md border-b border-white/5">
        <div className="flex items-center p-4 py-3 justify-between">
          <div className="text-white flex size-12 shrink-0 items-center justify-start">
            <span className="material-symbols-outlined cursor-pointer text-2xl">menu</span>
          </div>
          ...
          <div className="flex w-12 items-center justify-end">
            <button 
              ...
              className="flex items-center justify-center rounded-full h-10 w-10 bg-primary/40 text-white border border-accent-gold/30 hover:bg-primary/60 transition-colors"
            >
      ...
      <div className="fixed bottom-24 right-6 z-50">
        <button 
          ...
          className="flex items-center justify-center w-16 h-16 rounded-full bg-primary text-accent-gold shadow-[0_8px_30px_rgb(0,0,0,0.5)] border-2 border-accent-gold hover:scale-110 active:scale-95 transition-transform duration-200"
        >
          <span className="material-symbols-outlined text-3xl fill-1">smart_toy</span>
        </button>
      </div>
