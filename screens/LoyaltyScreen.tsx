            ...
            <div className="bg-primary/5 dark:bg-primary/20 rounded-xl p-5 border border-primary/10">
              ...
              <button
                onClick={async () => {
                  ...
                  if (granted) alert('Notifications enabled! We will alert you when you earn rewards.');
                }}
                className="mt-4 w-full flex items-center justify-between p-3 bg-accent-gold/5 rounded-lg border border-accent-gold/20 hover:bg-accent-gold/10 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <span className="material-symbols-outlined text-accent-gold">notifications_active</span>
                  <p className="text-[10px] text-white font-bold uppercase tracking-wider text-left">Enable Push Alerts<br /><span className="text-white/40 font-normal normal-case">Get notified about exclusive drops</span></p>
                </div>
                <span className="material-symbols-outlined text-accent-gold group-hover:translate-x-1 transition-transform">chevron_right</span>
              </button>
            </div>
          </div>
